...
const Header = ({ onOpenCV }) => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-20 flex items-center z-50 bg-zinc-950/85 backdrop-blur-xl rounded-b-2xl sm:rounded-b-3xl shadow-lg shadow-zinc-950/50 transition-all duration-300">
